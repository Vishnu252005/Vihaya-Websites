...
export const Courses: React.FC = () => {
  ...
  const handleBrowseAllCourses = () => {
    console.log('Browse All Courses clicked');
    navigate('/courses');
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {sampleCourses.map((course, index) => (
            <motion.div
              ...
              whileHover={{ y: -10 }}
              className="bg-gray-50 dark:bg-gray-900 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden cursor-pointer"
        ...
        >
          <motion.button
            ...
            className="bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white px-8 py-3 rounded-lg font-semibold border border-gray-300 dark:border-gray-600 hover:border-blue-500 hover:text-blue-600 dark:hover:text-blue-400 transition-all duration-300"
